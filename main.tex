...
\thesistitle{Contribution to an automated thermos-mechanical CAE process of the Parametrized turbine blade with internal cooling system} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Pr. Bernd \textsc{Beirow}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
\examiner{} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
\degree{Dr Engineer} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
\author{Behnam  \textsc{Nouri}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
\addresses{} % Your address, this is not currently used anywhere in the template, print it elsewhere with \addressname

\subject{Biological Sciences} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
\keywords{} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
\university{\href{http://www.university.com}{Brandenburgische Technische Universität Cottbus-Senftenberg}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
In the drive for higher cycle efficiencies in gas turbine engines, turbine blades are seeing an increasingly high heat load. This in turn demands improvements in the internal cooling system and a better understanding of both the level and distribution of the internal heat-transfer. A typical approach to enhance the internal cooling of the turbine blade is by casting angled ‘low blockage’ ribs on the walls of the cooling channels. The objective of the present thesis is to determine the detailed Nusselt number distribution in rectangular internal channels with ribs. This knowledge can be used to guide the overall design e.g. to achieve high levels of heat-transfer where required. The effects of rotation as well as the interaction effects of the position and direction of ribs on opposite walls of the cooling channel have been investigated.
